...
- keep the active-project list as the single source of truth for relay scope
...
- keep idle watchdog runs silent, and only send user-facing updates when the watchdog actually changes something meaningful
